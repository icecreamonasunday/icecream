function shrinkHeader() {
    window.addEventListener('scroll', function(e){
        var distanceY = window.pageYOffset || document.documentElement.scrollTop,
            ...
            blogTitleFirstLine = document.getElementsByClassName('blog-title-first-line')[0];
            if (distanceY < 57) {
                var titleSizeOffset = 87 - distanceY;
                blogTitle.setAttribute('style', 'font-size:' +
                     titleSizeOffset + 'px; line-height:' + titleSizeOffset + 'px;');
            }
            else {
